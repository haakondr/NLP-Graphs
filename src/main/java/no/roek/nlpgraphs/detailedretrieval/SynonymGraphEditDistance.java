...
public class SynonymGraphEditDistance extends GraphEditDistance {
	...
	public SynonymGraphEditDistance(Graph g1, Graph g2, double subCost, double insCost, double delCost) {
		super(g1, g2, subCost, insCost, delCost);
		synonymService = new SynonymService();
	}
	
	public SynonymGraphEditDistance(Graph g1, Graph g2) {
		this(g1, g2, 2, 1, 1);
	}
